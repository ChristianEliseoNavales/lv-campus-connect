...
const Settings = () => {
  ...
  const fetchQueueSettings = async () => {
    try {
      const response = await fetch(`${API_CONFIG.getAdminUrl()}/api/settings/queue/admissions`);
      if (response.ok) {
  ...
  const fetchServices = async () => {
    try {
      const response = await fetch(`${API_CONFIG.getAdminUrl()}/api/services/admissions`);
      if (response.ok) {
        const data = await response.json();
        setServices(data);
      }
  ...
  const fetchAdminUsers = async () => {
    try {
      ...
      const response = await fetch(`${API_CONFIG.getAdminUrl()}/api/users/by-role/admissions_admin`);
      if (response.ok) {
        const data = await response.json();
        setAdminUsers(data);
      } else {
  ...
  const fetchLocationSettings = async () => {
    try {
      const response = await fetch(`${API_CONFIG.getAdminUrl()}/api/settings/location/admissions`);
      if (response.ok) {
        const data = await response.json();
  ...
  const handleToggleQueueing = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_CONFIG.getAdminUrl()}/api/settings/queue/admissions/toggle`, {
        method: 'PUT',
        headers: {
