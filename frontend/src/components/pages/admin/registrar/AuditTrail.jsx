    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2.5">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Registrar Department Security & Activity Log</p>
          </div>
        </div>
        <div className="flex items-center space-x-2.5">
          <button className="flex items-center space-x-1.5 px-3 py-1.5 bg-gray-600 text-white rounded-lg font-semibold text-sm hover:bg-gray-700 transition-colors">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div className="text-center py-10">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-1.5">No audit logs available</h3>
          <p className="text-sm text-gray-500">Audit trail functionality will be implemented soon</p>
        </div>
      </div>
    </div>
  );
