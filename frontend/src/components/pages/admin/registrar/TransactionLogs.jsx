...
const TransactionLogs = () => {
  ...
  const fetchTransactionLogs = useCallback(async () => {
    ...
    try {
      ...
      const url = `${API_CONFIG.getAdminUrl()}/api/transactions/registrar?${params.toString()}`;
  ...
  const fetchServices = useCallback(async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Include all active services (Document Request will be shown but validation will prevent submission)
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await authFetch(`${API_CONFIG.getAdminUrl()}/api/admin/transactions/registrar`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
