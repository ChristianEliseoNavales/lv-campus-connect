...
const FAQ = () => {
  ...
  }, [currentPage, faqsPerPage, searchTerm, filterStatus]); // Dependencies include all filter params
  ...
  }, [searchTerm, filterStatus, updateState]);
              ...
              <div className="divide-y divide-gray-200">
                {[...Array(7)].map((_, index) => (
                  <div key={index} className="px-3 sm:px-4 md:px-5 py-2.5 sm:py-3 md:py-3 md:h-12 flex items-center animate-pulse">
                    ...
                    {/* Mobile skeleton */}
                    <div className="md:hidden w-full space-y-1.5 sm:space-y-2">
