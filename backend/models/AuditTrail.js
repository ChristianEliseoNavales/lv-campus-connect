...
const auditTrailSchema = new mongoose.Schema({
  ...
  action: {
    ...
    enum: [
      ...
      'QUEUE_CREATE', 'QUEUE_CALL', 'QUEUE_SERVE', 'QUEUE_COMPLETE', 'QUEUE_SKIP', 'QUEUE_CANCEL', 'QUEUE_REQUEUE_ALL', 'QUEUE_REQUEUE_SELECTED', 'QUEUE_PREVIOUS', 'QUEUE_RECALL', 'QUEUE_TRANSFER',
