...
const validateAuditLog = [
  body('action')
    .isIn([
      ...
      'QUEUE_CREATE', 'QUEUE_CALL', 'QUEUE_SERVE', 'QUEUE_COMPLETE', 'QUEUE_SKIP', 'QUEUE_CANCEL', 'QUEUE_PREVIOUS', 'QUEUE_RECALL', 'QUEUE_TRANSFER', 'QUEUE_REQUEUE_ALL', 'QUEUE_REQUEUE_SELECTED',
