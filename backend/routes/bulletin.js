...
router.post('/upload', verifyToken, checkApiAccess, bulletinController.upload.single('file'), bulletinController.uploadBulletin);

// DELETE /api/bulletin/delete/:publicId - Delete file from Cloudinary
router.delete('/delete/:publicId', verifyToken, checkApiAccess, bulletinController.deleteBulletin);
